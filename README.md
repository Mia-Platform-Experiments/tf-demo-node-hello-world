...
```shell
docker pull nexus.mia-platform.eu/hcp-terraform/tf-demo-node-hello-world:latest
set -a
source .env
docker run --name tf-demo-node-hello-world \
  --detach \
  nexus.mia-platform.eu/hcp-terraform/tf-demo-node-hello-world
```

[merge-request]: https://github.com/Mia-Platform-Experiments/tf-demo-node-hello-world/merge_requests
